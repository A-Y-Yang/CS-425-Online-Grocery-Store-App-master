from wtforms import Form, StringField, validators, SelectField, IntegerField, DecimalField, SelectMultipleField, FloatField
...
class AddstockForm(Form):
    ...
    size_total = FloatField('Size', [validators.DataRequired()])