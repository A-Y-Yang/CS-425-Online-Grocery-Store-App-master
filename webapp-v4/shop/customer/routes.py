...
def food_list(id):
    ...
    customer = Customer.query.get_or_404(id)
    return render_template('customer/food_list.html', title = 'Customer Page', products = products,customer = customer,categories=categories)
...
def alcohol_list(id):
    ...
    customer = Customer.query.get_or_404(id)
    return render_template('customer/alcohol_list.html', title = 'Customer Page', products = products,customer = customer,categories=categories)
...
def nonalcohol_list(id):
    ...
    customer = Customer.query.get_or_404(id)
    return render_template('customer/nonalcohol_list.html', title = 'Customer Page', products = products,customer = customer,categories=categories)
